...
export const competitions: Competition[] = [
  {
    ...
    eventTimeline: [
      ...
      { date: "2026-09-20", event: "Winners Announced", phase: "winner_announcement" },
    ],
  ...
  },
  {
    ...
    eventTimeline: [
      { date: "2026-09-01", event: "Invitations Sent", phase: "upcoming" },
      { date: "2026-09-15", event: "Competition Begins", phase: "in_progress" },
      { date: "2026-10-01", event: "Grand Finale", phase: "winner_announcement" },
    ],
