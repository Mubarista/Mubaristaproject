...
const sections = [
  { label: "Hero & Stats", href: "/mbhubteam/hero", icon: Home, color: "text-blue", bg: "bg-blue/10", api: null },
  { label: "Competitions", href: "/mbhubteam/competitions", icon: Trophy, color: "text-yellow", bg: "bg-yellow/10", api: "/api/competitions" },
  { label: "Winners", href: "/mbhubteam/winners", icon: Medal, color: "text-yellow", bg: "bg-yellow/10", api: "/api/winners" },
  { label: "Latte Art", href: "/mbhubteam/latte-art", icon: Image, color: "text-blue", bg: "bg-blue/10", api: "/api/latte-art" },
  { label: "Testimonials", href: "/mbhubteam/testimonials", icon: Star, color: "text-green", bg: "bg-green/10", api: "/api/testimonials" },
  { label: "Sponsors", href: "/mbhubteam/sponsors", icon: Building2, color: "text-muted", bg: "bg-muted-bg", api: "/api/sponsors" },
  { label: "Coffee Facts", href: "/mbhubteam/coffee-facts", icon: Coffee, color: "text-yellow", bg: "bg-yellow/10", api: "/api/coffee-facts" },
  { label: "Tips & Skills", href: "/mbhubteam/tips", icon: Lightbulb, color: "text-yellow", bg: "bg-yellow/10", api: "/api/tips" },
  ...
  { label: "Coffee Timeline", href: "/mbhubteam/timeline", icon: Clock, color: "text-yellow", bg: "bg-yellow/10", api: "/api/timeline" },
  { label: "Legends", href: "/mbhubteam/legends", icon: UserCheck, color: "text-blue", bg: "bg-blue/10", api: "/api/legends" },
  { label: "About", href: "/mbhubteam/about", icon: FileText, color: "text-blue", bg: "bg-blue/10", api: null },
  { label: "Contact", href: "/mbhubteam/contact", icon: Building2, color: "text-green", bg: "bg-green/10", api: null },
  { label: "Message Center", href: "/mbhubteam/messages", icon: MessageSquare, color: "text-blue", bg: "bg-blue/10", api: "/api/contact" },
  { label: "Countries", href: "/mbhubteam/countries", icon: Globe, color: "text-green", bg: "bg-green/10", api: null },
  { label: "Payments", href: "/mbhubteam/payments", icon: DollarSign, color: "text-green", bg: "bg-green/10", api: "/api/payments" },
  { label: "Judges", href: "/mbhubteam/judges", icon: Scale, color: "text-blue", bg: "bg-blue/10", api: "/api/judges" },
];
