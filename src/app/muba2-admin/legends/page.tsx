...
const blank: Omit<Legend, 'id' | 'createdAt' | 'updatedAt'> = { name: "", country: "", image: "", biography: "", achievements: "", awards: "", legacy: "", active: true, order: 0 };
...
export default function AdminLegendsPage() {
  ...
  function openEdit(l: Legend) { setDraft({ name: l.name, country: l.country, image: l.image, biography: l.biography, achievements: l.achievements, awards: l.awards, legacy: l.legacy, active: l.active, order: l.order }); setEditing(l); }
